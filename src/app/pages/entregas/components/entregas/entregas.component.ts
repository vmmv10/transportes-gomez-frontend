...
@Component({
    ...
    imports: [CommonModule, TableModule, TagModule, ButtonModule, FormsModule, InputTextModule, BreadcrumbModule, RouterModule, ToastModule, ConfirmDialogModule, TooltipModule, ModalLoadingComponent],
